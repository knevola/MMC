...
summary(ADRB1_meta)
forest(ADRB1_meta, digits = 4,colgap.forest = unit(0, "mm"), fontfamily = "sans", colgap.studlab = unit(-5, "mm"))

HDAC4_meta <- metagen(TE = HDAC4$beta, seTE = HDAC4$se, studlab = HDAC4$Cohort,pval = HDAC4$p)
summary(HDAC4_meta)
forest(HDAC4_meta, digits = 4,colgap.forest = unit(0, "mm"), fontfamily = "sans", colgap.studlab = unit(-5, "mm"))
