...
fem_results_lin <- read.csv("Model3_linear_miRNA_LMEKIN_eQTL_topSNPs_fem.csv")
male_results_lin <- read.csv("Model3_linear_miRNA_LMEKIN_eQTL_topSNPs_male.csv")
fem_results_log <- read.csv("Model3_logistic_miRNA_LMEKIN_eQTL_topSNPs_fem.csv")
male_results_log <- read.csv("Model3_logistic_miRNA_LMEKIN_eQTL_topSNPs_male.csv")
...
write.csv(fem_results, "Model3_FisherMethod_eQTL_fem.csv", quote = F, row.names = F)
write.csv(male_results, "Model3_FisherMethod_eQTL_male.csv", quote = F, row.names = F)
