...
#============================================================================
# fix length, simpleM
fn_In <- "/home/clary@mmcf.mehealth.org/Framingham/OmicData/MMC/Genetic Association Study/other genes/data/simpleM_allSNPs_postQC_genomewide.txt"				# <---- change path here!!!
